...
@Component({
  selector: 'app-questionnaire02',
  templateUrl: './questionnaire02.component.html',
  styleUrls: ['./questionnaire02.component.css']
})
export class Questionnaire02Component implements OnInit {
